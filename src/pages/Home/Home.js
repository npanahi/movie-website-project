              ...
              <div className="logo center-text m-t-100">
                ...
                <div className="feature-logos center-text">
                  <div>
                    <img
                      alt="logos"
                      src="/assets/photos/futered-in-logos.png"
                    />
                  </div>
                    ...
                    <div className="container">
                      <ul className="flex-x">
                        ...
                        <li className="col-3">
                          <img
                            alt="ipad"
                            src="/assets/photos/iphone/ipad.svg"
                          />
                        ...
                        items={[
                          {
                            ...
                            children: (
                              <p>
                                Apple TV+ lets you watch Apple Original shows
                                and movies produced exclusively for Apple.
                              </p>
                            ),
                          },
                        ]}
                        ...
                        items={[
                          {
                            ...
                            children: (
                              <p>
                                Yes.With Apple TV+ you can share your
                                subscription with up to five family members.
                              </p>
                            ),
                          },
                        ]}
